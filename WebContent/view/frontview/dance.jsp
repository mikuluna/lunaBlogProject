...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/dance.css" />
</head>
<body>
<!--头部开始-->
		<div class="nav_head">
			<div class="jidiao"></div>
			<a href="#" ><img  src="${pageContext.request.contextPath}/img/nav_luna.png"/><p>my</p></a>
			<a href="#" class="a dianji"><img  src="${pageContext.request.contextPath}/img/nav_dance.png" /><p>舞蹈</p></a>
