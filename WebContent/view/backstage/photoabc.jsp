...
<body>
	<div class="login-fullmain">
			...
			<div class="coursestepbutton">
				<label class="upload">
			<b>上传图片</b>
 			<input class="change" type="file" multiple="multiple" onchange="imgPreview(this)" >
		</label>
			</div>
			<mvc:form modelAttribute="lunaPhoto" action="uploadHand.do" enctype="multipart/form-data">
				<div class="steps">
				</div>
